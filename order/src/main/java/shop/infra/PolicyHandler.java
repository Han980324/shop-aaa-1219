...
public class PolicyHandler {
    ...
    public void wheneverDeliveryStarted_Updatestaus(
        @Payload DeliveryStarted deliveryStarted
    ) {
        DeliveryStarted event = deliveryStarted;
        System.out.println(
            "\n\n##### listener Updatestaus : " + deliveryStarted + "\n\n"
        );

        // Sample Logic //
        Order.updatestaus(event);
    }
    ...
    public void wheneverDeliveryReturned_Updatestaus(
        @Payload DeliveryReturned deliveryReturned
    ) {
        DeliveryReturned event = deliveryReturned;
        System.out.println(
            "\n\n##### listener Updatestaus : " + deliveryReturned + "\n\n"
        );
